...
__pairs - (Lua 5.2+) Handle iteration through table pairs when for k,v in pairs(tbl) do ... end is called (See http://lua-users.org/wiki/GeneralizedPairsAndIpairs). 

__ipairs - (Lua 5.2+) Handle iteration through table pairs when for k,v in ipairs(tbl) do ... end is called (See http://lua-users.org/wiki/GeneralizedPairsAndIpairs). 
